...
#define aegis256x2_COMMITBYTES aegis256x2_KEYBYTES
 ...
 */
int aegis256x2_mac_update(aegis256x2_state *st_, const uint8_t *m, size_t mlen);
 ...
 */
int aegis256x2_mac_final(aegis256x2_state *st_, uint8_t *mac, size_t maclen);
 ...
 */
int aegis256x2_mac_verify(aegis256x2_state *st_, const uint8_t *mac, size_t maclen);
 ...
 */
void aegis256x2_mac_state_clone(aegis256x2_state *dst, const aegis256x2_state *src);
 ...
 * with `aegis256x2_mac_state_clone()`.
 */
int aegis256x2_mac_init_with_commitment(aegis256x2_state *st_, uint8_t *kc, const uint8_t *k);
 ...
 */
int aegis256x2_mac_init_verify_commitment(aegis256x2_state *st_, const uint8_t *kc,
                                          const uint8_t *k);
