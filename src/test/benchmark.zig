...
fn bench_aegis256() !void {
    ...
    var c: [msg_len + aegis.aegis128x4_ABYTES_MIN]u8 = undefined;
    var m: [msg_len]u8 = undefined;
    ...
    mem.doNotOptimizeAway(c);
    const bits: f128 = @floatFromInt(@as(u128, msg.len) * iterations * 8);
...
fn bench_aegis128l() !void {
    ...
    var c: [msg_len + aegis.aegis128l_ABYTES_MIN]u8 = undefined;
    var m: [msg_len]u8 = undefined;
...
fn bench_aegis128x2() !void {
    ...
    var c: [msg_len + aegis.aegis128x2_ABYTES_MIN]u8 = undefined;
    var m: [msg_len]u8 = undefined;
