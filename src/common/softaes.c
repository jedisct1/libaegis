...
uint32_t _aes_lut_s1[256] __attribute__((visibility("hidden"))) = {
...
uint32_t _aes_lut_s2[256] __attribute__((visibility("hidden"))) = {
...
uint32_t _aes_lut_s3[256] __attribute__((visibility("hidden"))) = {
...
static const uint32_t* const LUT_S1 = _aes_lut_s1;
static const uint32_t* const LUT_S2 = _aes_lut_s2;
static const uint32_t* const LUT_S3 = _aes_lut_s3;
