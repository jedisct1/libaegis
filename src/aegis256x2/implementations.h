...
typedef struct aegis256x2_implementation {
    ...
    int (*state_encrypt_detached_final)(aegis256x2_state *st_, uint8_t *c, size_t clen_max,
                                        size_t *written, uint8_t *mac, size_t maclen);
    int (*state_encrypt_final)(aegis256x2_state *st_, uint8_t *c, size_t clen_max, size_t *written,
                               size_t maclen);
    int (*state_decrypt_detached_update)(aegis256x2_state *st_, uint8_t *m, size_t mlen_max,
